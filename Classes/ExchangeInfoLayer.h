...
class ExchangeInfoLayer : public cocos2d::Layer, public cocos2d::ui::EditBoxDelegate
{
public:
	virtual bool init();

	CREATE_FUNC(ExchangeInfoLayer);
    
public:
    void Send_ExchangeHistory();
...
private:
    void onHttpRequest_ReqExchgeHistory(cocos2d::network::HttpClient* sender, cocos2d::network::HttpResponse *response);
